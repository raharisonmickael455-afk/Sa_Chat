"""
Django settings for sa_chat project.
...
WSGI_APPLICATION = 'sa_chat.wsgi.application'
...
# Development fallback: reset links are printed by Django instead of being sent by an unconfigured SMTP server.
